  ...
  return (
    <Grid container style={{ minHeight: '100vh' }}>
      <Grid item xs={12} sm={6}>
        <img
          src={
            'https://web-static.wrike.com/cdn-cgi/image/width=880,format=auto,q=80/blog/content/uploads/2020/03/Global-Project-Management.jpg?av=15ec480845adf18b79dea8f75a80bd72'
          }
      ...
      <Grid container item xs={12} sm={6} justifyContent="center" alignItems="center">
        <Paper elevation={10} style={paperStyle}>
          <Grid style={headerStyle}>Sign In</Grid>
